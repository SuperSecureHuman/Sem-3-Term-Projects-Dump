    ...
    def back_prop(self, dE_dY, alpha):
        ...
        for patch, h, w in self.patches_generator(self.image):
            ...
            for f in range(self.kernel_num):
                # Add the patch to the gradient of the kernel
...
class MaxPoolingLayer:
    ...
    def forward_prop(self, image):
        ...
        for patch, h, w in self.patches_generator(image):
            # compute the maximum value of the patch and store in the corresponding position in the max_pooling_output matrix
    ...
    def back_prop(self, dE_dY):
        ...
        for patch,h,w in self.patches_generator(self.image):
            ...
            # Extract the patch of the image at the position h,w
            # and get the number of kernels
            max_val = np.amax(patch, axis=(0,1))
            # Compute the maximum value of each kernel over the patch
